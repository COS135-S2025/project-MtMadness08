...
void readHardFile()
{
    ...
    // This always takes in the Hard file, and always in read mode
    ...
    // Makes a new file
    // This file is to be a copy of the original Hard file
    ...
    // Deletes the old Hard file
    remove("HardFile.txt");

    // Renames the copy to the Hard file
    rename("Copy.txt", "HardFile.txt");
